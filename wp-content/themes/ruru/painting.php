...
$sql = "SELECT
    ...
    FROM 
        $wpdb->posts
    WHERE 
        $wpdb->posts.post_type = 'picture' AND $wpdb->posts.post_status = 'publish'
    ORDER BY 
        $wpdb->posts.menu_order ASC";
         
$results = $wpdb->get_results($sql);
$numposts = $wpdb->get_var("SELECT count(*) FROM $wpdb->posts WHERE post_status = 'publish' AND post_type = 'picture'");
